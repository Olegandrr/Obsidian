...
*Flux* - это архитектурный шаблон для разработки веб-приложений для управления состоянием пользовательского интерфейса. 
*Flux представляет собой однонаправленный поток данных, где данные перемещаются от "действий" (actions) к "хранилищу" (store), а затем к "представлению" (view).*
