...
* [[024 Что такое «ленивая» (Lazy) функция|Что такое «ленивая» (`Lazy`) функция? Что такое `<Suspense/>`]]
...
* [[027 Что такое синтетические события (SyntheticEvent) в React|Что такое синтетические события (`SyntheticEvent`)? Что такое `event.persist()`?]]
...
* [[Методы Redux Toolkit|Какие методы есть в `Redux Toolkit`?]]
...
* [[128 Можете ли вы описать опыт работы со сложной структурой данных в приложении React. Как вы с этим справились|Можете ли вы описать опыт работы со сложной структурой данных в приложении React? Как вы с этим справились? Что такое `debounce`? Что такое `throttle`? Использовали ли вы библиотеку `Lo-dash`?]]
